...
export const register = catchAsyncError(async(req,res,next)=>{
   ...
   if(user) return next(new ErrorHandler("user Already Exists",409));
    ...
    sendToken(res,user,"Registerd Successfully")
...
export const changePassword = catchAsyncError(async(req,res,next)=>{
    ...
    return next(new ErrorHandler("Please enter all field",420))
...
export const forgetPassword = catchAsyncError(async (req, res, next) => {
    ...
    const message = `Click on the link to reset your password: ${url}. If you have not requested this, please ignore it.`;
